...
3. Click **Download** link below to download the ingredient shopping list dataset as a csv file.
""")
...
if download:
    ...
    st.write("""
    • Ingredient shopping list preview - click "Download full csv file" url above for full ingredient shopping list:
    """)
    st.dataframe(df_download.head(10))